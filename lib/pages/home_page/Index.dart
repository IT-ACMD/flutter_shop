...
class _IndexState extends State<Index> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarA(
        child: AppBar(title: Text(titleStr)), //searchButtonBar(),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.assignment), //receipt
            title:
                Text("Categories", style: TextStyle(fontSize: 14.0)), //设置文字和颜色
          ),
          BottomNavigationBarItem(
